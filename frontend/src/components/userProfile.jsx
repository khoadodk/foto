...
const activeBtnStyles =
  'bg-red-500 capitalize text-white font-bold p-2 rounded-lg shadow-lg w-20 outline-none';
const notActiveBtnStyles =
  'bg-primary capitalize text-black mr-4 font-bold p-2 rounded-lg w-20 outline-none';
